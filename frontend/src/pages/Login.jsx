  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 p-4 relative overflow-hidden text-zinc-100">
      ...
      >
        ...
        {/* Mode Tabs */}
        <div className="flex mb-6 p-1 bg-zinc-900/60 border border-white/5 rounded-xl relative z-10">
          <button
            type="button"
            onClick={() => setMode("password")}
            className={`flex-1 py-2.5 text-[10px] tracking-[0.2em] uppercase rounded-lg transition-all cursor-pointer ${
              mode === "password"
